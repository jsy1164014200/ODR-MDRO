function [ f_opt,X_opt,CPUTime ] = PrimaryNewsvendorUpperGivenB( ZIGMA,mu,A,b,gamma1,gamma2,c,v,g,m1, B)
...
cvx_begin sdp
                ...
                q + A1Complete'*(A'*Landa1) == B*u1;
                q + A1Complete'*(A'*Landa2+(v-g)) == B*u2;
